...
bar2 = Bar("Cafe Martinez", "Pueyrredon y Cordoba", [wifi, aircon, precios])
bar3 = Bar("Starbucks", "Las Heras y Uriburu", [aircon, precios])
...
bar8 = Bar("Milli", "Pueyrredon y French", [wifi, aircon,precios])
